	    ...
	    <main>
	    	<div>
		    	<aside>
		    		<nav>
					 	<ul class="admin-nav-ul">
							 ...
							 <li><a href="#" class="active">Salary Details</a></li>
						</ul>
					</nav>
		    	</aside>
		        <section class="content">
				   	 <div class="col-md-12">
				   		<br>
					  <form method="POST" action="salary_details_insert.php">
						  <div>
						  ...
						  <input type="text" name="deductDetails_id" class='form-control' required>
						  </div>
						  <div>
