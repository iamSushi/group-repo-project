	    ...
	    <main>
	    	<div>
		    	<aside>
		    		<nav>
					 	<ul class="admin-nav-ul">
							 ...
							 <li><a href="#" class="active">Permanent Address</a></li>
		        ...
		        <section class="content">
				   	 <div class="col-md-12">
				   		<br>
					  <form method="POST" action="permanent_addrress_insert.php">
						  <div>
						  ...
						  <input type="text" name="addOne" class='form-control' required>
						  </div>
						  <div>
						  <label>Street:</label>
						  <input type="text" name="addTwo" class='form-control' required>
						  </div>
						  <div>
						  <label>Barangay:</label>
						  <input type="text" name="addTre" class='form-control' required>
						  </div>
						  <div>
						  <label>State:</label>
