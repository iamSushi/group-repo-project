								...
								?>
									<form action="">
										<div class="container form-group">
											<legend><h2>Mother's Information</h2></legend>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													<span class="input-group-addon">Firstname:</span>
													<span class='form-control'><?php echo $row['mothers_fname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['mothers_mname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['mothers_lname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['mothers_birthdate'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
