								...
								?>
									<form action="">
										...
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['course'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['schoolName'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
										...
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													<span class="input-group-addon">Scholl Year Graduated:</span>
													<span class='form-control'><?php echo $row['yearEnd'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
										...
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['percentage'] ?></span>
												</div>
											</div>
										</div>
									</form>
