										...
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['fathers_fname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['fathers_mname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['fathers_lname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['fathers_birthdate'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
										...
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['fathers_contnum'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['fathers_occupation'] ?></span>
												</div>
											</div>
										</div>
									</form>
