								...
								?>
									<form action="">
										<div class="container form-group">
											<legend><h2>Spouse</h2></legend>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													<span class="input-group-addon">Firstname:</span>
													<span class='form-control'><?php echo $row['spouse_fname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['spouse_mname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['spouse_lname'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['spouse_birthdate'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['spouse_contnum'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['spouse_occupation'] ?></span>
												</div>
											</div>
										</div>
										<div class="container form-group form-horizontal">
											<div class="inputGroupContainer">
												<div class="input-group">
													...
													<span class='form-control'><?php echo $row['numOfChildren'] ?></span>
												</div>
											</div>
										</div>
									</form>
