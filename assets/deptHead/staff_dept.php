						...
						<?php
							...
							echo "<table class='table'>";
								...
								echo "<tr>";
									...
									echo "<td>
										<a href='update.php?sid=".$row['staff_id']."' class='btn btn-primary' style='width:85px;'>View</a>
										<a href='update.php?sid=".$row['staff_id']."' class='btn btn-warning' style='width:85px;'>Sched</a>
