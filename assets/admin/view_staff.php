			 	 ...
			 	 <div class="container-fluid" style="padding-left: 0;">
			 	 	...
			 	 	<ul class="nav navbar-right nav-btn">
				 	 	<div class="input-group">
							<form action="search_view_staff.php" method="post">
								 <div class="input-group">
									  <input type="text" class="form-control" placeholder="Search Staff" aria-describedby="basic-addon1" name="search">
									  <span class="input-group-addon" id="basic-addon1" style="padding: 0;"><button class="btn" name="send"><i class="glyphicon glyphicon-search"></i></button></span>
								</div> 
							</form>
						</div>
					</ul>
