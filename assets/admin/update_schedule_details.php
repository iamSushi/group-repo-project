...
<body>
	...
	<div class="col-sm-10 content">
		...
		<?php
				...
				$id = $_GET['id'];
				$sql = "SELECT * FROM schedule_details WHERE schedDetails_id = '$id'";
							    ...
							    <div class="form-group">
							 	...
							 	<div class="form-group">
								    ...
								    <div class="col-sm-5 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
											  <input type="time" name="afternoonTimein" class='form-control' required placeholder="Morning Time In" value="<?php echo $row['afternoonTimein'];?>">
										</div>
									</div>
								</div>
							    <div class="form-group">
									...
									<div class="col-sm-5 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
											 <input type="time" name="afternoonTimeout" class='form-control' required placeholder="Morning Time Ouy" value="<?php echo $row['afternoonTimeOut'];?>">
										</div>
									</div>
							 	</div>
							     <div class="form-group">
